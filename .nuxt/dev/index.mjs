...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Accelerating Memetic DeFi"},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","href":"/favicon.ico"}],"style":[],"script":[{"src":"/scripts/font-awesome/all.js"}],"noscript":[],"title":"Fun CryptoIA Finances, people with democratized IA digital finances","htmlAttrs":{"lang":"es"}};
