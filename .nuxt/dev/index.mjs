...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[{"src":"/scripts/font-awesome/all.js"}],"noscript":[],"title":"Fun CryptoIA Finances, people with democratized IA digital finances"};
