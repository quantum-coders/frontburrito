...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/devalue/index.js';
import destr from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/destr/dist/index.mjs';
import { hash } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/consola/dist/index.mjs';
import devalue from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/syn4ps3/Documents/gitworkspace/frontburrito/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/syn4ps3/Documents/gitworkspace/frontburrito/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/syn4ps3/Documents/gitworkspace/frontburrito","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/syn4ps3/Documents/gitworkspace/frontburrito/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/syn4ps3/Documents/gitworkspace/frontburrito/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/syn4ps3/Documents/gitworkspace/frontburrito/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/syn4ps3/Documents/gitworkspace/frontburrito/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _0tIicDNU2o = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/syn4ps3/Documents/gitworkspace/frontburrito";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _tuEhKBxCNQ = (nitroApp) => {
...
const _lazy_nAy4j3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_nAy4j3, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nAy4j3, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Accelerating Memetic DeFi"},{"name":"format-detection","content":"telephone=no"},{"hid":"og:title","property":"og:title","content":"MemeAI index"},{"hid":"og:description","property":"og:description","content":"Accelerating Memetic DeFi"},{"hid":"og:image","property":"og:image","content":"https://burritoai.finance/burrito-IA-finance-logo.png"},{"hid":"og:url","property":"og:url","content":"https://burritoai.finance/"},{"hid":"twitter:card","name":"twitter:card","content":"summary_large_image"},{"hid":"twitter:title","name":"twitter:title","content":"Accelerating Memetic DeFi"},{"hid":"twitter:description","name":"twitter:description","content":"Accelerating Memetic DeFi"},{"hid":"twitter:image","name":"twitter:image","content":"https://burritoai.finance/burrito-IA-finance-logo.png"}],"link":[{"rel":"icon","href":"/favicon.ico"}],"style":[],"script":[{"src":"/scripts/font-awesome/all.js"}],"noscript":[],"htmlAttrs":{"lang":"en"}};
...
const getClientManifest = () => import('file:///home/syn4ps3/Documents/gitworkspace/frontburrito/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
