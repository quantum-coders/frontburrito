					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Total Staked</h6>
										<p class="card-text display-4" v-if="stakingStats">
							...
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Total Stakers</h6>
										<p class="card-text display-4" v-if="stakingStats">
							...
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Monthly APR</h6>
										<p class="card-text display-4" v-if="stakingStats">
							...
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Annual APR</h6>
										<p class="card-text display-4" v-if="stakingStats">
							...
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Available Rewards</h6>
										<p class="card-text display-4" v-if="stakingStats">
				...
				<div class="card">
					...
					<div class="card-body">
						<table class="table table-striped table-hover">
							...
							<tbody>
							<tr v-for="staker in stakers" :key="staker.walletAddress">
								<td>
									<a :href="`https://snowtrace.io/address/${staker.walletAddress}`" target="_blank">
					...
					<div class="card-body">
						<ul class="nav nav-tabs" id="metricsTab" role="tablist">
							<li class="nav-item" role="presentation">
								<button class="nav-link" :class="{ active: activeTab === 'tvl' }" id="tvl-tab"
										@click="activeTab = 'tvl'"
										type="button" role="tab" aria-controls="tvl"
										:aria-selected="activeTab === 'tvl'">TVL History
								</button>
							</li>
							<li class="nav-item" role="presentation">
								<button class="nav-link" :class="{ active: activeTab === 'apr' }" id="apr-tab"
										@click="activeTab = 'apr'"
										type="button" role="tab" aria-controls="apr"
										:aria-selected="activeTab === 'apr'">APR History
								</button>
							</li>
						</ul>
						<div class="tab-content" id="metricsTabContent">
							<div class="tab-pane fade" :class="{ 'show active': activeTab === 'tvl' }" id="tvl"
								 role="tabpanel"
								 aria-labelledby="tvl-tab" v-if="activeTab === 'tvl'">
								<table class="table table-striped table-hover mt-3">
									...
									<tbody>
									<tr v-for="item in stakingMetrics.tvlHistory" :key="item.timestamp">
							...
							<div class="tab-pane fade" :class="{ 'show active': activeTab === 'apr' }" id="apr"
								 role="tabpanel"
								 aria-labelledby="apr-tab" v-else>
								<table class="table table-striped table-hover mt-3">
									<thead class="table-primary">
									<tr>
										<th scope="col">Timestamp</th>
									...
									<tbody>
									<tr v-for="item in stakingMetrics.aprHistory" :key="item.timestamp">
										<td>{{ formatTimestamp(item.timestamp) }}</td>
...
<!--		<div class="row mb-4">
			<div class="col-md-12">
				<div class="card">
					<div class="card-header bg-primary text-white">
						<h5 class="mb-0">User Analytics (0x1234567890abcdef1234567890abcdef12345678)</h5>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Total Stakes</h6>
										<p class="card-text display-4">{{ userAnalytics.totalStakes }}</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Active Stakes</h6>
										<p class="card-text display-4">{{ userAnalytics.activeStakes }}</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Total Staked</h6>
										<p class="card-text display-4">{{ userAnalytics.totalStaked }}</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Currently Staked</h6>
										<p class="card-text display-4">{{ userAnalytics.currentlyStaked }}</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Total Rewards Earned</h6>
										<p class="card-text display-4">{{ userAnalytics.totalRewardsEarned }}</p>
									</div>
								</div>
							</div>
							<div class="col-md-4 mb-3">
								<div class="card h-100 border-primary">
									<div class="card-body d-flex flex-column justify-content-center align-items-center">
										<h6 class="card-title text-primary">Average Stake Duration</h6>
										<p class="card-text display-4">{{ userAnalytics.averageStakeDuration }}</p>
									</div>
								</div>
							</div>
						</div>

						<h5 class="mt-4 text-primary">Transaction History (Type: Stake, Limit: 10, Offset: 0)</h5>
						<table class="table table-striped table-hover mt-3">
							<thead class="table-primary">
							<tr>
								<th scope="col">#</th>
		...
		<div class="row mb-4">
			<div class="col-md-12">
				<div class="card">
					<div class="card-header bg-primary text-white">
						<h5 class="mb-0">Staking Snapshots (Limit: 24, Offset: 0)</h5>
					</div>
					<div class="card-body">
						<table class="table table-striped table-hover">
							<thead class="table-primary">
		...
		<div class="row mb-4">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
						<button class="btn btn-primary" @click="createManualSnapshot" :disabled="loadingSnapshot">
              <span v-if="loadingSnapshot" class="spinner-border spinner-border-sm" role="status"
					aria-hidden="true"></span>
							<span v-else>Create Snapshot</span>
						</button>
						<div v-if="snapshotCreationResult" class="mt-3 alert"
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-4 mb-3">
								...
								<input type="number" class="form-control" id="fromBlock" v-model="fromBlock">
							</div>
							<div class="col-md-4 mb-3">
								<label for="toBlock" class="form-label">To Block</label>
								<input type="number" class="form-control" id="toBlock" v-model="toBlock">
							</div>
							<div class="col-md-4 mb-3 d-flex align-items-end">
								<button class="btn btn-primary" @click="processHistoricalData"
										:disabled="loadingHistorical">
                  <span v-if="loadingHistorical" class="spinner-border spinner-border-sm" role="status"
						aria-hidden="true"></span>
									<span v-else>Process Data</span>
								</button>
							</div>
						</div>
						<div v-if="historicalDataResult" class="mt-3 alert"
