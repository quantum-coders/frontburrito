...
import { c as consola } from '../shared/nuxi.892d3e71.mjs';
import 'node:util';
import 'node:path';
import 'node:process';
import 'node:tty';
...
import { l as loadKit } from '../shared/nuxi.1d712bcd.mjs';
import { l as loadNuxtManifest, w as writeNuxtManifest } from '../shared/nuxi.1e03ca1a.mjs';
import { a as clearBuildDir } from '../shared/nuxi.1bd3c493.mjs';
      ...
      this.listener.server.on(
        ...
        async (req, socket, head) => {
          if (req.url.startsWith(
            this._currentNuxt?.options.app.buildAssetsDir
          )) {
            return;
          }
